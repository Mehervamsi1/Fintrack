            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <FadeIn className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Track expenses, manage investments, and achieve your financial goals with our all-in-one dashboard.
                </p>
              </FadeIn>
              <FadeIn delay={0.2} className="space-x-4">
                <Link href="/signup">
                  <Button className="h-11 px-8">Get Started</Button>
                </Link>
                <Link href="/login">
                  <Button variant="outline" className="h-11 px-8">Login</Button>
                </Link>
              </FadeIn>
            </div>
          </div>
